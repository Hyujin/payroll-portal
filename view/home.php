...
<html>
    <header>
        ...
        <Title>Altria Payroll Portal</Title>
    ...
    <body>
        <div class="container-fluid">
            <div class="row flex-nowrap">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li>
                                <a href="employees.php" class="nav-link text-light px-0 align-middle">
                                    <i class="fs-5 bi-people"></i> <span class="ms-1 d-none d-sm-inline">Add Employees</span></a>
                            </li>                    
                ...
                <div class="col py-3">
                    <!-- CONTENT AREA -->
                   <iframe src="../frames/home.php" height="100%" width="100%"  id="home-container">
